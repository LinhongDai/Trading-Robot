...
class StockFrame():
    ...
    def __init__(self, data: List[dict]) -> None:
        ...
        self.symbol_groups: DataFrameGroupBy = None
        self._symbol_rolling_groups: RollingGroupby = None

    @property
    def frame(self) -> DataFrameGroupBy:
    ...
    def add_rows(self, data: dict) -> None:
        ...
        for quote in data:
            ...
            # parse that timestamp(cuz that column needs a datetime object)
